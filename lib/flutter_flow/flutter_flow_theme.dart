...
abstract class FlutterFlowTheme {
  ...
  late Color darkText;
  late Color darkBrightText;
  late Color whiteText;
  late Color grayTextAndIcon;
  late Color backgroundElements;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4E7BFF);
  late Color secondary = const Color(0xFFFF7B00);
  late Color tertiary = const Color(0xFF79BF00);
  ...
  late Color tertiaryText = const Color(0xFFA7A7A7);
  ...
  late Color grayTextAndIcon = const Color(0xFFA7A7A7);
  late Color backgroundElements = const Color(0xFFF4F4F4);
}
...
class ThemeTypography extends Typography {
  ...
  String get displayLargeFamily => 'Goldman';
  bool get displayLargeIsCustom => false;
  TextStyle get displayLarge => GoogleFonts.goldman(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 64.0,
      );
  String get displayMediumFamily => 'Goldman';
  bool get displayMediumIsCustom => false;
  TextStyle get displayMedium => GoogleFonts.goldman(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 44.0,
      );
  String get displaySmallFamily => 'Goldman';
  bool get displaySmallIsCustom => false;
  TextStyle get displaySmall => GoogleFonts.goldman(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 36.0,
      );
  String get headlineLargeFamily => 'Goldman';
  bool get headlineLargeIsCustom => false;
  TextStyle get headlineLarge => GoogleFonts.goldman(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 24.0,
      );
  String get headlineMediumFamily => 'Goldman';
  bool get headlineMediumIsCustom => false;
  TextStyle get headlineMedium => GoogleFonts.goldman(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 16.0,
      );
  String get headlineSmallFamily => 'Goldman';
  bool get headlineSmallIsCustom => false;
  TextStyle get headlineSmall => GoogleFonts.goldman(
        color: theme.primaryText,
