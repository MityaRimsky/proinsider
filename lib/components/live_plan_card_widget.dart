...
import 'live_plan_card_model.dart';
export 'live_plan_card_model.dart';

class LivePlanCardWidget extends StatefulWidget {
  const LivePlanCardWidget({
    super.key,
...
class _LivePlanCardWidgetState extends State<LivePlanCardWidget> {
  late LivePlanCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LivePlanCardModel());
  }
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            fit: BoxFit.cover,
            image: Image.asset(
              'assets/images/Forecast_card_red.png',
            ).image,
          ),
          boxShadow: [
            BoxShadow(
