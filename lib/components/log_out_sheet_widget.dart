...
import 'log_out_sheet_model.dart';
export 'log_out_sheet_model.dart';

class LogOutSheetWidget extends StatefulWidget {
  const LogOutSheetWidget({super.key});

  @override
  State<LogOutSheetWidget> createState() => _LogOutSheetWidgetState();
}

class _LogOutSheetWidgetState extends State<LogOutSheetWidget> {
  late LogOutSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogOutSheetModel());
  }
