...
class _SettingNotificationsPageWidgetState
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserNotificationPreferencesRow>>(
      future: UserNotificationPreferencesTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<UserNotificationPreferencesRow>
            settingNotificationsPageUserNotificationPreferencesRowList =
            snapshot.data!;

        final settingNotificationsPageUserNotificationPreferencesRow =
            settingNotificationsPageUserNotificationPreferencesRowList
                    .isNotEmpty
                ? settingNotificationsPageUserNotificationPreferencesRowList
                    .first
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            value: _model.switchValue1 ??=
                                settingNotificationsPageUserNotificationPreferencesRow!
                                    .pushEnabled,
